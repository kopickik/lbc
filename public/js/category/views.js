...
(function() {
  var CategoriesView, CategoryResultView, CategoryRowDisplayView, CategoryRowEditView, CategorySearchView, _ref,
  ...
  CategorySearchView = (function(_super) {
    ...
    function CategorySearchView() {
      return CategorySearchView.__super__.constructor.apply(this, arguments);
    }
    ...
    CategorySearchView.prototype.search = function(e) {
      e.preventDefault();
      return this.model.trigger('search');
    };

    CategorySearchView.prototype.clear = function(e) {
      e.preventDefault();
  ...
  CategoryResultView = (function(_super) {
    ...
    CategoryResultView.prototype.itemSave = function(view) {
      ...
      return model.save(null, {
        ...
        error: function(rmodel, response) {
    ...
    CategoryResultView.prototype.itemEdit = function(view) {
      ...
      return $rowView.attr('id', model.id);
    };
